...
> Por exemplo, a URL [https://github.com/joseobr1992/dio-lab-open-source](https://github.com/joseobr1992/dio-lab-open-source) é o "**fork**" feito pelo usuário do GitHub "`joseobr1992`" para a contribuição no repositório `dio-lab-open-source`.
